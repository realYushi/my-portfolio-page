...
export const ContactFooter = ({ email }: ContactFooterProps) => {
  return (
    <section
      id="contact"
      className="bg-gradient-to-b from-background to-muted/10 border-t border-border section-padding-small"
    >
      <div className="section-container max-w-5xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="section-description mb-12">
            Ready to build something great? Let's get in touch and discuss how
        ...
        <div className="text-center pt-12 border-t border-border/50">
          ...
          <p className="ui-text text-muted-foreground text-sm">
            © 2025 Yushi Cui. All rights reserved.
          </p>
        </div>
      </div>
    </section>
